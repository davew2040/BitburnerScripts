...
export async function main(ns : NS) : Promise<void> {
    ...
    try {
        ...
        await ns.sleep((weakenTime-growTime)-2*completionBufferTimeMilliseconds);
        ...
        await ns.sleep(3*completionBufferTimeMilliseconds+hackTime);

        await logger.log(ns, 'COMPLETED HACK PART CYCLE');
